...
void KuruKuruImage::Draw(Transform& transform, RECT rect, float alpha, float startangle, float endangle, float start)
{
	//いろいろ設定
	Direct3D::SetShader(Direct3D::SHADER_CIRCLEGAUGE);
